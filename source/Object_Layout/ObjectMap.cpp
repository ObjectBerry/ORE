...
Object_Layout::ObjectMap* Object_Layout::ObjectMap::createMethod(Memory::MemoryAllocator* allocator, unsigned short slotCount, Object_Layout::SlotDescription scopeLink, Objects::Code* code, Object_Layout::MethodInfo* methodInfo) {

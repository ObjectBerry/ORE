...
Object_Layout::ExecutableMap::ExecutableMap(Memory::MemoryAllocator* allocator, unsigned short slotCount, Objects::ByteArray* bytecode, Objects::ObjectArray* literals, ScopeType scopeType, ReturnType returnType) : Object_Layout::ObjectMap(allocator, slotCount) {
...
Object_Layout::ExecutableMap* Object_Layout::ExecutableMap::create(Memory::MemoryAllocator* allocator, unsigned short slotCount, Objects::ByteArray* bytecode, Objects::ObjectArray* literals, ScopeType scopeType, ReturnType returnType) {
	return new(allocator) Object_Layout::ExecutableMap(allocator, slotCount, bytecode, literals, scopeType, returnType); 
};
